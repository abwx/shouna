...
const useThemeStore = common_vendor.defineStore("theme", {
  state: () => ({
    themeKey: common_vendor.index.getStorageSync("shouna_theme") || "morandi"
  }),
  getters: {
    themes: () => THEMES,
  ...
  actions: {
    setTheme(key) {
      ...
      common_vendor.index.setStorageSync("shouna_theme", next.key);
    }
  }
});
exports.useThemeStore = useThemeStore;
//# sourceMappingURL=../../.sourcemap/mp-weixin/stores/theme.js.map
